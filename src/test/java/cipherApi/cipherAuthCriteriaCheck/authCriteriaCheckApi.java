package cipherApi.cipherAuthCriteriaCheck;
...
public class authCriteriaCheckApi extends readConfig {
    ...
    String url = loadProperties().getProperty("getAuthCriteriaCheckUrl");
    String excelPath = loadProperties().getProperty("excelPath");
    String sheetName = loadProperties().getProperty("getAuthCriteriaCheckSheetName");
    ...
    @DataProvider(name = "testAuthCriteriaCheck")
    ...
    @Test(priority = 1, dataProvider="testAuthCriteriaCheck", enabled = true)
